...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white space-y-4">
            <h1 className="text-4xl font-bold">Welcome to Naagrik Sampark</h1>
            <p className="text-xl opacity-90">Every Report Matters</p>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t civic-shadow-soft z-50">
